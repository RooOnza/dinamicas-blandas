  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav ml-auto">
        ...
        <?php else : ?>
          <?php if ($_SESSION['auth_status'] == false) : ?>
          <li class="nav-item">
            <a class="nav-link <?php if (strtolower($active) === 'login') echo 'active'; ?>" href="<?php echo BASE_URL; ?>login.php">login</a>
          </li>
          <li class="nav-item">
        ...
        <?php if (isset($_SESSION['auth_status'])) : ?>
          <?php if ($_SESSION['auth_status']) : ?>
          <li class="nav-item">
            <a href="<?php echo BASE_URL; ?>lienzoAdm.php" class="nav-link <?php if (strtolower($active) === 'lienzoadm') echo 'active'; ?>">lienzo</a>
          </li>
          <?php endif; ?>
        <?php endif; ?>
        <?php if (isset($_SESSION['auth_status'])) : ?>
